...
API_ID = int(os.environ.get("API_ID", "38598233"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "9badf30be109f9a0121490d3a7f50c05")
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://ghost_ninja:QWEasdZXC@cluster0.vf2to1b.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
